...
const videoList = [
  { name: "Dry Down feat Ben Snaath", link: "./Video/Dry_Down_feat_Ben_Snaath.mp4" },
  { name: "He's", link: "./Video/He's.mp4"},
  { name: "Leapt", link: "./Video/Leapt.mp4"},
  { name: "Water Feature", link: "./Video/Water_Feature.mp4"}
];
